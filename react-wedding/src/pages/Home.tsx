...
const homeTranslations: Record<
  TranslationLang,
  { p1: string; p4: string; motto: string }
> = {
  en: {
    p1: `Woho, the time has come! Tom & Gérry are finally tying the knot — and that in the fateful 7th year! ❤️ Eight years ago at Kotti in Berlin, Tom surely wouldn’t have guessed that one day he’d be getting married in Ulm — but hey, life happens! We want to spend this special day with you and are looking forward to an amazing mix of Italians, Swiss, Swabians, and the crazy Berliners! `,

    p4: ` We're looking forward to celebrating this beautiful day in our garden — true to the motto:`,
    motto: `"Italy meets Schwaben."`,
  },
  it: {
    p1: `Ci siamo: Tom & Gérry si sposano! ❤️ Siamo felicissimi di poter condividere questo giorno così importante con voi e di festeggiare insieme a un mix meraviglioso di italiani, tedeschi, svizzeri, berlinesi, pescaresi, e chi più ne ha più ne metta! Otto anni fa, Tom non avrebbe certo immaginato che un giorno si sarebbe sposato proprio a Ulm, nel bel mezzo della Germania. Ma si sa, la vita è piena di sorprese! `,
  ...
  de: {
    p1: `Woho, es ist so weit! Tom & Gérry geben sich das Ja-Wort – und das im verflixten 7. Jahr! ❤️ Wer hätte das gedacht? Damals, vor 8 Jahren am Kotti in Berlin, konnte sich Tom wohl kaum vorstellen, dass er mal im Schwabenländle in Ulm heiraten würde – aber hey, life happens! Diesen besonderen Tag wollen wir mit euch feiern – mit einem kunterbunten Mix aus Italianos, Schweizern, Schwaben und den loco Berlinern!`,
